...
export const SavedScreen = () => {
    ...
    const contactedProperties =  properties;
    const applicationProperties = properties;
            ...
            if(applicationProperties)
             ...
             return(
                <>
                 ...
                 />
                   {getBodyText(
                   "Check the Status of your Rental Properties",
                   "Any Property you have applied will show Up here"
                  )}
                  {!user && 
                  <SignUpAndSignInButtons 
                    style={styles.signUpSignInButtonContainer} 
